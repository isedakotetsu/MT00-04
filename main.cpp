...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	while (Novice::ProcessMessage() == 0) {
		...
		///
		/// ↓描画処理ここから
		Novice::ScreenPrintf(0, kRowHeight  + 60, "rotateXMatrix");
		MatrixScreenPrintf(0, 0, rotateXMatrix, "rotateXMatrix");
		Novice::ScreenPrintf(0, kRowHeight + 160, "rotateYMatrix");
		MatrixScreenPrintf(0, kRowHeight * 5, rotateYMatrix, "rotateYMatrix");
		Novice::ScreenPrintf(0, kRowHeight  + 260, "rotateZMatrix");
		MatrixScreenPrintf(0, kRowHeight * 5 * 2, rotateZMatrix, "rotateZMatrix");
		Novice::ScreenPrintf(0, kRowHeight  + 370, "rotateXYZMatrix");
